...
plot "datos_angle.dat" u 1:(($3**2-$2**2)*1e-12)/$7:(2*(1.0/sqrt(50000))*1e-12*($2**2+$3**2)/$7) with yerrorbars ti "Tracking (PLACET)", "" u 1:($5/$7) w lp ti "Approx. (MAPCLASS2)"
